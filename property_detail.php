...
$sql_2 = "SELECT * FROM testimonals WHERE property_id = $property_id";
...
$sql_4 = "SELECT * FROM interested_users_properities WHERE property_id = $property_id";
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list_without_react.php?city=<?= $property['city_name']; ?>"><?= $property['city_name']; ?></a>
            </li>
